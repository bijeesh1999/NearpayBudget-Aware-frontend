...
import { deleteOneBudget, putOneBudget } from "@/src/app/nearpay/redux/slices/budget.slice";
import NewBudgetForm from "./components/form";
import Drawer from "../../components/drawer";
import { Header } from "../../components/header";
import { listUserCategory } from "@/src/app/nearpay/redux/slices/category.slice";
import { AddBudget } from "./components/addButton";
import LoaderCards, { NoDataCard } from "./components/skeliton";
...
export default function BudgetManager() {
  ...
  const { categories, status, isLoading } =
  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mt-20 mx-auto bg-gray-50 min-h-screen">
      <Header>
        <Month close={close} />
        <AddBudget isOpen={open} />
      </Header>
      <div className="bg-white shadow-xl w-[700px] rounded-xl p-6 mt-6">
        {" "}
